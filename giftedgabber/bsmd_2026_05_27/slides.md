...
<div style="background: white; border: 3px solid #422C76; padding: 1.5rem 3rem; border-radius: 12px; font-size: 2rem; font-weight: 800; color: #422C76;">
TRUE
</div>

<v-click>

<div style="background: #EE7962; padding: 1.5rem 3rem; border-radius: 12px; font-size: 2rem; font-weight: 900; color: white; box-shadow: 0 12px 30px -8px rgba(238, 121, 98, 0.5);">
FALSE
</div>
...
Plus over <strong style="color: #422C76; font-style: normal;">$15M in merit aid</strong> placed across Brown PLME, Stony Brook Scholars for Medicine, NJMS, Drexel, Pitt GAP, and Rice/Baylor.
</p>
...
<p style="font-size: 1.7rem; margin-top: 1rem; color: #422C76; font-weight: 700; line-height: 1.4;">
They ran a <span style="color: #EE7962;">different path entirely</span>.
</p>
...
<div style="margin-top: 3rem; display: inline-block; background: white; border: 2px solid #422C76; border-radius: 12px; padding: 1.25rem 2.5rem;">

<p style="font-size: 1.15rem; color: #422C76; font-weight: 600; margin: 0;">
