...
<div class="absolute inset-0 flex flex-col justify-center px-24 z-10 text-left">
  <div class="ecf-kicker mb-3">How this works</div>
  <div class="ecf-rule mb-7"></div>
  <div class="ecf-mid">And let me say the awkward parts out loud rather than</div>
  <div v-click class="ecf-mid ecf-mark mt-2">have you find them later.</div>
</div>
...
<div class="absolute inset-0 flex flex-col justify-end px-20 pb-20 z-10 text-left">
  ...
  <div class="ecf-hero">I've owned care homes myself.</div>
</div>
...
<div class="absolute inset-0 flex flex-col justify-center px-24 z-10 text-left">
  <div class="ecf-kicker mb-3">How this works</div>
  <div class="ecf-rule mb-7"></div>
  <div class="ecf-head">and I know which questions get you a straight</div>
  <div v-click class="ecf-head ecf-mark mt-2">answer on a tour.</div>
</div>
...
<div class="absolute inset-0 flex flex-col justify-end px-20 pb-20 z-10 text-left">
  <div class="ecf-kicker mb-3">How this works</div>
  <div class="ecf-rule mb-5"></div>
  <div class="ecf-head">And I get paid</div>
  <div v-click class="ecf-head ecf-mark mt-2">by the home.</div>
</div>
...
<div class="absolute inset-0 flex flex-col justify-center px-24 z-10 text-left">
  <div class="ecf-kicker mb-3">How this works</div>
  <div class="ecf-rule mb-7"></div>
  <div class="ecf-head">You pay nothing, not now</div>
  <div v-click class="ecf-head ecf-mark mt-2">and not later.</div>
</div>
...
<div class="absolute inset-0 flex flex-col justify-center px-24 z-10 text-left">
  <div class="ecf-kicker mb-3">How this works</div>
  <div class="ecf-rule mb-7"></div>
  <div class="ecf-head">The only answer I've</div>
  <div v-click class="ecf-head ecf-mark mt-2">got is this.</div>
</div>
...
<div class="absolute inset-0 flex flex-col justify-center px-24 z-10 text-left">
  <div class="ecf-kicker mb-3">How this works</div>
  <div class="ecf-rule mb-7"></div>
  <div class="ecf-mid">My reputation around here is worth a great deal more to</div>
  <div v-click class="ecf-mid ecf-mark mt-2">me than filling one bed.</div>
</div>
...
<div class="absolute inset-0 flex flex-col justify-end px-20 pb-20 z-10 text-left">
  <div class="ecf-kicker mb-3">How this works</div>
  <div class="ecf-rule mb-5"></div>
  <div class="ecf-head">So here's what our</div>
  <div v-click class="ecf-head ecf-mark mt-2">call actually is.</div>
</div>
...
<div class="absolute inset-0 flex flex-col justify-end px-20 pb-20 z-10 text-left">
  <div class="ecf-kicker mb-3">How this works</div>
  <div class="ecf-rule mb-5"></div>
  <div class="ecf-head">And the catch, since you're</div>
  <div v-click class="ecf-head ecf-mark mt-2">waiting for one.</div>
</div>
...
<div class="absolute inset-0 flex flex-col justify-end px-20 pb-20 z-10 text-left">
  <div class="ecf-kicker mb-3">How this works</div>
  <div class="ecf-rule mb-5"></div>
  <div class="ecf-head">Three quick things and I'll</div>
  <div v-click class="ecf-head ecf-mark mt-2">let you go.</div>
</div>
