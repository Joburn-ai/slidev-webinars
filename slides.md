...
<div class="text-3xl mt-8 opacity-80">
The Complete System for Guaranteed AP Success
</div>
...
I have 5 simple <span class="text-accent">True/False questions</span>
</div>
...
<div class="text-2xl">
I'll ask you a question and you type
</div>
...
<span style="color: var(--brand-accent);">T</span> for True
</div>
...
<span style="color: var(--brand-primary);">F</span> for False
</div>
...
If your student gets an <span style="color: #10b981;">A</span> in their AP class...
</div>
...
<div class="text-6xl mt-12 font-bold">
True or False?
</div>
...
<div class="text-7xl font-bold text-red-600 mb-12">
FALSE
</div>
...
Classroom grades and AP exam scores operate on **completely different systems**
...
<div class="text-8xl font-bold" style="color: var(--brand-accent);">
$40,000+
</div>
...
<div class="text-3xl mt-8">
in lost college credits every year
</div>
...
<div class="text-3xl mb-8">
More practice without the right strategy
</div>
...
<div class="text-5xl font-bold" style="color: var(--brand-primary);">
Actually reinforces WRONG approaches
</div>
...
<div class="text-3xl">
It's like practicing free throws
</div>
...
<div class="text-5xl font-bold mt-6" style="color: var(--brand-primary);">
Missing the mark
</div>
...
Students who score 4s and 5s don't study **more**
...
<div class="text-5xl font-bold my-8" style="color: var(--brand-primary);">
$125+ per hour
</div>
...
Insider knowledge of scoring systems

Understanding of grader frameworks

Access to real rubrics
...
<div class="text-6xl font-bold" style="color: var(--brand-primary);">
THOUSANDS
</div>
...
<div class="text-3xl mt-8">
on tutoring and still watch their kids
</div>
...
<div class="text-5xl font-bold mt-6 text-red-600">
Miss college credits
</div>
...
<div class="text-5xl font-bold my-8" style="color: var(--brand-accent);">
300% in five years
</div>
...
Outdated strategies from YOUR generation
</div>
...
Now that AI screens applications
...
<div class="text-5xl font-bold my-6 text-red-600">
Burnout
</div>
...
<div class="text-3xl mb-8">
Right now, thousands of hardworking students
</div>
...
<div class="text-7xl font-bold text-red-600 my-8">
2s and 3s
</div>
...
<div class="text-6xl font-bold my-8" style="color: var(--brand-accent);">
Tens of thousands
</div>
...
<div class="text-6xl font-bold mt-8 text-red-600">
...
<div class="text-6xl font-bold mt-8" style="color: var(--brand-primary);">
...
<div class="text-6xl font-bold" style="color: var(--brand-accent);">
Their dream school
</div>
...
Expensive solutions that leave families **more confused**

Realizing that traditional 'work harder' approaches **actually make things worse**
