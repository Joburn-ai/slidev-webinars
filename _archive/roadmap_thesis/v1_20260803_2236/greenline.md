...
<div class="rt-kicker">ALL THREE GATES &middot; ANSWERED TOGETHER</div>
...
flowchart LR
  ...
  linkStyle 0,1,2 stroke:#209080,stroke-width:3px
  linkStyle 3 stroke:#209080,stroke-width:4px
```

<div class="rt-h2 mt-6" v-click>Nothing you already learned gets thrown away.</div>
...
<div class="rt-kicker">ONE PLACE TO UNDERSTAND</div>
<div class="rt-h2">Six questions, answered in one place.</div>

<div class="grid grid-cols-3 gap-4 mt-8">
<v-clicks>

<div class="rt-card"><div class="rt-card-t">Where am I now?</div></div>
<div class="rt-card"><div class="rt-card-t">What is actually stopping me?</div></div>
<div class="rt-card"><div class="rt-card-t">What have I tried?</div></div>
<div class="rt-card"><div class="rt-card-t">What are my real options?</div></div>
<div class="rt-card"><div class="rt-card-t">What happens next?</div></div>
<div class="rt-card"><div class="rt-card-t">What does the transformation require from me?</div></div>
...
<div class="rt-h2">Not a lead magnet that describes the transformation.</div>
<div class="rt-h1 mt-8" v-click>The Roadmap is the transformation beginning.</div>
...
<div class="rt-kicker">WHAT HAPPENS INSIDE IT</div>
<div class="rt-h2">Five things, before they ever speak to you.</div>
...
<div class="rt-h1">They become more informed</div>
<div class="rt-h1 mt-4" v-click>whether or not they ever buy.</div>
...
<div class="rt-kicker">PRODUCT DEMONSTRATION</div>
<div class="rt-h1">You are going through it right now.</div>

<div class="rt-sub mt-8" v-click>We do not have to ask you to imagine what this feels like for your leads. You are inside it before you ever talk to us.</div>
...
<div class="rt-kicker">ASK YOURSELF</div>
<div class="rt-h2">You are the test case.</div>

<div class="grid grid-cols-2 gap-3 mt-6">
<v-clicks>

<div class="rt-card"><div class="rt-card-t">Did this help me understand the problem?</div></div>
<div class="rt-card"><div class="rt-card-t">Did the sequence feel clear?</div></div>
<div class="rt-card"><div class="rt-card-t">Did I feel pushed, or more informed?</div></div>
<div class="rt-card"><div class="rt-card-t">Would my leads benefit from this?</div></div>
<div class="rt-card"><div class="rt-card-t">Where did I lose interest?</div></div>
<div class="rt-card"><div class="rt-card-t">What would I change?</div></div>
...
<div class="rt-h1">THE ROADMAP IS NOT A PROMISE OF THE PRODUCT.</div>
<div class="rt-h1 mt-8" v-click>IT IS THE FIRST EXPERIENCE OF THE PRODUCT.</div>
...
<div class="rt-kicker">SECTION 5 &middot; DISTRIBUTION</div>
...
<div class="rt-kicker">EVERY ENTRANCE</div>
<div class="rt-h2">Ten front doors. One room.</div>

<div class="grid grid-cols-5 gap-2 mt-8">
<v-clicks>

<div class="rt-card rt-card-t text-center">Paid traffic</div>
<div class="rt-card rt-card-t text-center">Organic content</div>
<div class="rt-card rt-card-t text-center">YouTube</div>
<div class="rt-card rt-card-t text-center">Story sequences</div>
<div class="rt-card rt-card-t text-center">Link in bio</div>
<div class="rt-card rt-card-t text-center">Boosted reel</div>
<div class="rt-card rt-card-t text-center">Webinar</div>
<div class="rt-card rt-card-t text-center">Low-ticket purchase</div>
<div class="rt-card rt-card-t text-center">DM automation</div>
<div class="rt-card rt-card-t text-center">Outbound follow-up</div>
...
flowchart LR
  ...
  Y["YouTube and content"]:::proc
  L["Webinar and low ticket"]:::proc
  BK["Direct booking"]:::proc
  RD["THE ROADMAP"]:::hub
  W["One argument. One journey."]:::win
  P --> RD
  O --> RD
  Y --> RD
  L --> RD
  BK -- "confirmation flow" --> RD
  RD --> W
  ...
  classDef win fill:#DFF1ED,stroke:#209080,stroke-width:2px,color:#0A2230
  linkStyle 0,1,2,3,4 stroke:#209080,stroke-width:2.5px
  linkStyle 5 stroke:#209080,stroke-width:4px
```
...
<div class="rt-h1">One thing.</div>
<div class="rt-h2 mt-6" v-click>One central asset.</div>
<div class="rt-h2 mt-3" v-click>One argument.</div>
<div class="rt-h2 mt-3" v-click>One place the business keeps improving.</div>
...
<div class="rt-kicker">WHAT THE TEAM MAINTAINS</div>
<div class="rt-h2">Same headcount. Different job.</div>

<div class="grid grid-cols-2 gap-6 mt-10">
<v-clicks>

<div class="rt-card bad">
<div class="rt-card-t">Maintain five disconnected funnels</div>
<div class="rt-card-s mt-2">Five arguments, five sets of learnings, none of them transferable</div>
</div>

<div class="rt-card good">
<div class="rt-card-t">Keep making the Roadmap better</div>
<div class="rt-card-s mt-2">One argument, improved on a schedule, and every channel inherits it</div>
</div>
...
<div class="rt-h2">The entry can change.</div>
<div class="rt-h1 mt-8" v-click>The central journey does not.</div>
...
<div class="rt-kicker">ONE ARGUMENT, MANY ENTRANCES</div>
<div class="rt-h2">This is not one generic ad for everybody.</div>

<div class="mt-10">
<v-clicks>

<div class="rt-h2">Different awareness states need different entrances.</div>
<div class="rt-h2 mt-6">The entrances converge on the same belief architecture.</div>
...
<div class="rt-h2">More access to the market.</div>
<div class="rt-h1 mt-8" v-click>Without a different business for every segment.</div>
...
<div class="rt-kicker">SECTION 6 &middot; UNAWARE</div>
<div class="rt-h2">They do not know the symptoms share a cause.</div>

<div class="rt-card good mt-10 max-w-3xl" v-click>
<div class="rt-card-t">Lead with curiosity. Help them recognize the pattern.</div>
</div>
...
<div class="rt-kicker">SECTION 6 &middot; PROBLEM AWARE</div>
<div class="rt-h2">They know the problem. They do not know why the obvious fixes failed.</div>

<div class="rt-card good mt-10 max-w-3xl" v-click>
<div class="rt-card-t">Become useful by articulating the problem more clearly than they can.</div>
</div>
...
<div class="rt-kicker">SECTION 6 &middot; SOLUTION AWARE</div>
<div class="rt-h2">They already know the solutions.</div>

<div class="grid grid-cols-4 gap-3 mt-8">
<v-clicks>

<div class="rt-card rt-card-t text-center">VSLs</div>
...
<div class="rt-card rt-card-t text-center">Agencies</div>
<div class="rt-card rt-card-t text-center">Setters</div>
<div class="rt-card rt-card-t text-center">Content</div>
<div class="rt-card rt-card-t text-center">AI</div>
...
<div class="rt-h2">Your job is not to pretend those never work.</div>
<div class="rt-h1 mt-8" v-click>It is to show why disconnected solutions send them back into The Restart.</div>
...
<div class="rt-h2">Not separate companies.</div>
<div class="rt-h2 mt-5" v-click>Not even separate funnels.</div>
<div class="rt-h1 mt-8" v-click>Three entrances into one belief architecture.</div>
...
<div class="rt-kicker">THREE ENTRANCES, ONE ARCHITECTURE</div>
...
flowchart LR
  ...
  S["Solution aware"]:::proc
  RD["THE ROADMAP"]:::hub
  B["One belief architecture"]:::win
  U -- "curiosity" --> RD
  P -- "clarity" --> RD
  S -- "contrast" --> RD
  RD --> B
...
<div class="rt-h2 mt-6" v-click>Then moves them toward the same new understanding.</div>
...
<div class="rt-h2">Getting somebody into the Roadmap is half the job.</div>
<div class="rt-h1 mt-8" v-click>A resource nobody consumes transforms nobody.</div>
